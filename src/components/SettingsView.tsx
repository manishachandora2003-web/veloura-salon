...
import { WhatsAppNotificationsTab } from './WhatsAppNotificationsTab.tsx';
    ...
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="flex items-center space-x-2 border-b border-slate-200 pb-2">
        ...
        >
          ...
          <span>Salon Profile & Business</span>
        </button>
        ...
        >
          ...
          <span className={`px-1.5 py-0.5 rounded-full text-[10px] font-extrabold ${
            activeTab === 'notifications' ? 'bg-emerald-500 text-white' : 'bg-emerald-100 text-emerald-800'
          }`}>
            Meta & Twilio
          </span>
        </button>
      ...
      {activeTab === 'notifications' ? (
        <WhatsAppNotificationsTab settings={settings} />
      ) : (
        <>
